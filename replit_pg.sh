...
createdb -h localhost -p 5432 -U testuser
psql -h localhost -p 5432 -c "create database testDB;" -U testuser
psql -h localhost -p 5432 -d testDB -f db/migrations/*up.sql -U testuser
